...
| **Python Starter** | `python/starter/pyproject.toml` — `version =` | `python/starter/template/pyproject.toml.template` — `t0-provider-sdk>=0.1.0` (floor, **NOT bumped**) | n/a |
...
grep 'T0.ProviderSdk' csharp/starter/template/my-provider.csproj
