...
class ConfirmFundsReceivedResponse(_message.Message):
    ...
    class Reject(_message.Message):
        ...
        class Reason(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            ...
            REJECT_REASON_TRANSACTION_REFERENCE_ALREADY_USED: _ClassVar[ConfirmFundsReceivedResponse.Reject.Reason]
        ...
        REJECT_REASON_TRANSACTION_REFERENCE_ALREADY_USED: ConfirmFundsReceivedResponse.Reject.Reason
        REASON_FIELD_NUMBER: _ClassVar[int]
