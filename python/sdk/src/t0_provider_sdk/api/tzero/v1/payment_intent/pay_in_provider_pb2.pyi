...
class GetPaymentDetailsRequest(_message.Message):
    __slots__ = ("payment_intent_id", "confirmation_code", "payment_methods", "currency", "amount", "travel_rule", "beneficiary_provider_id")
